...
Description:
A console-based Library Management System in Java Core. Supports managing books and users, borrowing/returning books, and searching by ISBN, title, author, or year. All main features are covered with unit tests.
